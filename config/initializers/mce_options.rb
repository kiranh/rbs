configatron.default_mce_options = {
  ...
  :theme_advanced_buttons1 => %w{bold italic underline separator justifyleft justifycenter justifyright indent outdent separator bullist numlist separator separator undo redo code},
...
configatron.simple_mce_options = {
  ...
  :editor_deselector => "mceNoEditor",
  :theme_advanced_resize_horizontal => false,
  :theme_advanced_buttons1 => %w{bold italic underline separator bullist numlist separator},
  :theme_advanced_buttons2 => [],
  :theme_advanced_buttons3 => [],
